...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Mathew E. Hauer\textsuperscript{1}* (University of Georgia) and R. Dean Hardy\textsuperscript{2} (University of Maryland)},
             pdfkeywords = {},  
            pdftitle={A new conceptual typology for the population impacts of sea level rise},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
